...
public class V27__rematch_cafeteria_menu_items extends BaseJavaMigration {
    ...
    private List<MenuItem> menuItems(Connection connection, long optionId) throws SQLException {
        try (PreparedStatement statement = connection.prepareStatement("""
                select menu_item_id, raw_item_name
    ...
    private record MenuItem(long menuItemId, String rawItemName) {
    }
}
