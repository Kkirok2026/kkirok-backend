drop table if exists tmp_inha_dorm_pdf_seed;

create table tmp_inha_dorm_pdf_seed (
...
insert into tmp_inha_dorm_pdf_seed (served_date, meal_type, category_code, option_name, source_label, calories_kcal) values
...
where option_id in (
    ...
    where option_name /*!80000 collate utf8mb4_unicode_ci */ = '단호박콘샐러드 / 옥수수수염차' /*!80000 collate utf8mb4_unicode_ci */
);

insert into cafeteria_menu_item (option_id, food_id, raw_item_name, amount_g)
select o.option_id, null, x.raw_item_name, 100.00
from cafeteria_menu_option o
join (
    select '단호박콘샐러드' as raw_item_name
    union all
    select '옥수수수염차' as raw_item_name
) x
where o.option_name /*!80000 collate utf8mb4_unicode_ci */ = '단호박콘샐러드 / 옥수수수염차' /*!80000 collate utf8mb4_unicode_ci */;
